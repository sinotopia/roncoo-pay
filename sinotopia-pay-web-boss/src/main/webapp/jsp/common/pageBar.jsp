...
<div class="panelBar">
	<div class="pages">
		<span>显示</span>
		<select theme="simple" cssClass="combox" name="pageSize"
			value="${pageBean.pageSize}" onchange="navTabPageBreak({pageSize:this.value})">
	...
	<div class="pagination" targetType="navTab"
		totalCount="${pageBean.totalCount}" pageSize="${pageBean.pageSize}"
		pageNumShown="10"
