    ...
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${baseURL }/trade/listPaymentOrder"
        ...
        <div class="searchBar">
            <table class="searchContent">
                ...
                <tr>
                    <td>
                        下单开始日期:<input type="text" name="orderDateBegin" value="${paymentOrderQueryParam.orderDateBegin}"
                                      class="date textInput readonly" readonly="true">
                    </td>
                    <td>
                        下单结束日期:<input type="text" name="orderDateEnd" value="${paymentOrderQueryParam.orderDateEnd}"
                                      class="date textInput readonly" readonly="true">
                    </td>
                </tr>
                <tr>
