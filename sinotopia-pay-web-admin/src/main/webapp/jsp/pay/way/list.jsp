                ...
                <shiro:hasPermission name="pay:way:add">
                    <c:if test="${rpPayProduct.auditStatus=='NO'}">
                        <a title="设置支付方式" class="add"
                           href="${baseURL }/pay/way/addUI?payProductCode=${rpPayWay.payProductCode}"
                           target="navTab"><span>设置支付方式</span>
                        </a>
                    </c:if>
                </shiro:hasPermission>
            </li>
                ...
                <td>
                    <c:if test="${rpPayProduct.auditStatus=='NO'}">
                        <shiro:hasPermission name="pay:way:edit">
                            <a title="编辑" target="navTab" href="${baseURL }/pay/way/editUI?id=${item.id}"
