            ...
            <tr>
                ...
                <td>
                    <shiro:hasPermission name="pay:config:edit">
                        <a title="绑定出款银行卡" target="navTab"
                           href="${baseURL }/pay/config/editBankUI?userNo=${item.userNo}" style="color: blue;"
                           rel="zftdgl"> 绑定出款银行卡</a>
                        <a title="修改" target="navTab" href="${baseURL }/pay/config/editUI?userNo=${item.userNo}"
                           style="color: blue;" rel="zftdgl"> 修改</a>
                    </shiro:hasPermission>
