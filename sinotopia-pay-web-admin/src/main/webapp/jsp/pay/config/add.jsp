            ...
            <div>
                <fieldset>
                    ...
                    <dl>
                        <dt>支付产品编号：</dt>
                        <dd>
                            <input type="text" name="product.productCode" id="productCode" size="25" maxlength="128"
                ...
                <fieldset id="we_field" style="display: none;">
                    ...
                    <table style="border-spacing: 10px">
                        <tr>
                            <td>APPID：</td>
                            <td><input type="text" name="we_appId" id="we_appId" maxlength="128" class="required"/>&nbsp;&nbsp;请到“<a
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="we_partnerKey" id="we_partnerKey" maxlength="200"
                                       class="required"/>&nbsp;&nbsp;请到“<a href="https://pay.weixin.qq.com/"
                                                                           target="_blank"
                                                                           style="color: blue;">微信支付商户平台</a>”点击
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="we_merchantId" id="we_merchantId" maxlength="150"
                                       class="required"/>&nbsp;&nbsp;微信支付开通成功的通知邮件里，复制“微信支付商户号”，例如：10054321
                            </td>
                        </tr>
                    </table>
                </fieldset>
                ...
                <fieldset id="ali_field" style="display: none;">
                    ...
                    <table style="border-spacing: 10px">
                        <tr>
                            <td>合作者身份ID：</td>
                            <td><input type="text" name="ali_partner" id="ali_partner" maxlength="128"
                                       class="required"/></td>
                        </tr>
                        <tr>
                            <td>MD5_KEY：</td>
