...
<div class="pageContent">
    <form action="${baseURL }/reconciliation/mistake/handle" cssClass="pageForm required-validate"
          onsubmit="return validateCallback(this, navTabAjaxDone);" method="post">
        <input type="hidden" name="navTabId" value="dzcclb"/> <input type="hidden" name="callbackType"
                                                                     value="closeCurrent"/> <input type="hidden"
                                                                                                   name="forwardUrl"
                                                                                                   value=""/> <input
            type="hidden" name="id" value="${mistake.id}"/>
