...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${baseURL }/reconciliation/list/checkbatch"
          method="post">
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    <td>账单时间: <input type="text" class="date" name="billDay" value="${billDay}" class="required"
