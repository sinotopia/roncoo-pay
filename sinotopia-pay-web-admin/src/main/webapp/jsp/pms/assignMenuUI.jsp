...
<div class="pageContent">
    <form id="form" method="post" action="${baseURL}/pms/role/assignMenu" class="pageForm required-validate"
                        ...
                        <div id="treeDiv" layoutH="100"
                            ...
                            <fieldset style="width:99%">
                                ...
                                <c:forEach items="${menuList}" var="item">
                                    <label>
                                        <input type="checkbox" class="selectMenu" name="selectMenu"
                                               id="menuId${item.id }" value="${item.id }">${item.name }
                                    </label>
                                </c:forEach>
                            </fieldset>
                        </div>
