...
<div class="pageContent">
    ...
    <div class="panelBar">
        <ul class="toolBar">
            <li>
                <a class="add" href="${baseURL}/pms/role/addUI" target="dialog" width="550" height="300" rel="input"
                   title="添加角色">
                    <span>添加角色</span>
                </a>
            </li>
    ...
    <table class="table" targetType="navTab" asc="asc" desc="desc" width="100%" layoutH="111">
        ...
        <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
            ...
            <tr target="sid_user" rel="${id}">
                ...
                <td>
                    [
                    <a href="${baseURL}/pms/role/assignMenuUI?roleId=${item.id}" title="为角色【${item.roleName}】分配菜单"
                       target="dialog" width="950" style="color: blue">分配菜单</a>
                    ] &nbsp;[
                    <a href="${baseURL}/pms/role/assignPermissionUI?roleId=${item.id}" title="为角色【${item.roleName}】分配权限"
                       target="dialog" width="950" style="color: blue">分配权限</a>
                    ] &nbsp;[
                    <a href="${baseURL}/pms/role/editUI?roleId=${item.id}" title="修改角色【${item.roleName}】"
