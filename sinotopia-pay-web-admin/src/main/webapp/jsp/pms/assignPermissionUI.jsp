...
<div class="pageContent">
    <form id="form" method="post" action="${baseURL}/pms/role/assignPermission" class="pageForm required-validate"
        ...
        <div class="pageFormContent" layoutH="60">
            ...
            <div class="tabs" style="width:500px;float:left;">
                ...
                <div class="tabsContent">
                    <div>
                        <div id="treeDiv" layoutH="100"
                             style="float:left; display:block;overflow:auto; width:489px; border:solid 1px #CCC; line-height:21px; background:#fff">
                            <fieldset style="width:99%">
                                <legend>全选<input type="checkbox" name="selectAll" id="selectAll"></legend>
                                <c:forEach items="${permissionList}" var="v">
                                    <label>
                                        <input type="checkbox" class="selectPer" name="selectPer" id="perId${v.id }"
                                               value="${v.id }">${v.permissionName }
                                    </label>
                                </c:forEach>
                            </fieldset>
                        </div>
            ...
            <div class="tabs" style="width: 400px;float:left; ">
                ...
                <div class="tabsContent">
                    <div>
                        <div layoutH="100"
                             style="float:left; display:block; overflow:auto; width:389px; border:solid 1px #CCC; line-height:21px; background:#fff"
                             id="userDiv">
