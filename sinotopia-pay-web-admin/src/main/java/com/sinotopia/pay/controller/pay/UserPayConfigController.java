 ...
 */
package com.sinotopia.pay.controller.pay;

import javax.servlet.http.HttpServletRequest;

import com.sinotopia.pay.common.core.enums.SecurityRatingEnum;
...
import com.sinotopia.pay.user.enums.CardTypeEnum;
...
import com.sinotopia.pay.user.enums.BankCodeEnum;
...
public class UserPayConfigController {
    ...
    public String editBankUI(Model model, @RequestParam("userNo") String userNo) {
        ...
        RpUserInfo rpUserInfo = rpUserInfoService.getDataByMerchantNo(userNo);
