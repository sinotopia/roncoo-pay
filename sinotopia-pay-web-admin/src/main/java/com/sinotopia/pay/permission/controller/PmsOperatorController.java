...
import com.sinotopia.pay.common.core.enums.PublicStatusEnum;
import com.sinotopia.pay.common.core.pagination.PageBean;
import com.sinotopia.pay.common.core.pagination.PageParam;
import com.sinotopia.pay.permission.entity.PmsOperatorRole;
import com.sinotopia.pay.permission.utils.PasswordHelper;
...
public class PmsOperatorController extends BaseController {
	...
	public String addPmsOperator(HttpServletRequest req, PmsOperator pmsOperator, @RequestParam("selectVal") String selectVal, Model model, DwzAjax dwz) {
		try {
			...
			pmsOperator.setCreator(getPmsOperator().getLoginName());
