...
<div id="box" class="">
    <!-- 扫码 -->
    <div class="x-main">
        <div class="pro"><span>${scanPayByResult.productName}</span><span>应付金额 <b>￥<fmt:parseNumber type="number"
                                                                                                    pattern="#,#00.0#">${scanPayByResult.orderPrice}</fmt:parseNumber></b></span>
        </div>
    </div>
