 ...
 */
package com.sinotopia.pay.app.reconciliation;
...
import com.sinotopia.pay.app.reconciliation.utils.DateUtil;
import com.sinotopia.pay.app.reconciliation.utils.SpringContextUtil;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.springframework.context.support.ClassPathXmlApplicationContext;

import com.sinotopia.pay.app.reconciliation.biz.ReconciliationCheckBiz;
import com.sinotopia.pay.app.reconciliation.biz.ReconciliationFileDownBiz;
import com.sinotopia.pay.app.reconciliation.biz.ReconciliationFileParserBiz;
import com.sinotopia.pay.app.reconciliation.biz.ReconciliationValidateBiz;
import com.sinotopia.pay.app.reconciliation.vo.ReconciliationInterface;
import com.sinotopia.pay.reconciliation.entity.RpAccountCheckBatch;
import com.sinotopia.pay.reconciliation.enums.BatchStatusEnum;
import com.sinotopia.pay.reconciliation.service.RpAccountCheckBatchService;
import com.sinotopia.pay.reconciliation.vo.ReconciliationEntityVo;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int num = 0; num < reconciliationInterList.size(); num++) {
                ...
                // 创建对账批次
                batch.setCreator("reconciliationSystem");
